#coding=utf-8
"""
models as in "Deep Image Homography Estimation"
"""
...
parser.add_argument('--model_name', type=str, default='vgg_fpn')
...
def main():
    ...
    loader = data.loader_homographynet_images_offsets(args.train_data_dir, batch_size)
    val_loader = data.loader_homographynet_images_offsets(args.val_data_dir, batch_size)
